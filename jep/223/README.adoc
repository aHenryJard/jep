...
* link: https://groups.google.com/forum/#!topic/jenkinsci-dev/SHWZiMfbPEs[What is the best approach for mutually exclusive permissions - re: proposed Jenkins.CONFIGURE and Jenkins.SYSTEM_READ permissions]
